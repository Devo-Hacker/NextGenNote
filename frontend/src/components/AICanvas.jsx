...
const AICanvas = ({ isOpen, onClose, onNoteSaved }) => {
  ...
  return (
    <aside className="relative w-80 h-screen flex flex-col overflow-hidden border-l border-white/40 bg-[#f7f9fb]">
      <style>{`
      ...
      <div className="ai-canvas-root h-full w-full flex flex-col relative">
        ...
        {/* Header */}
        <header className="relative z-10 ai-canvas-glass flex items-center justify-between px-4 py-3.5 border-b-0">
        ...
        {/* Input area */}
        <div className="relative z-10 p-4 bg-white/10 border-t border-white/20">
          <div className="flex items-end gap-2 ai-canvas-input rounded-2xl p-1.5 pl-3.5 focus-within:border-[#762dd7]/50 transition-all">
            ...
            <button
              ...
              className="ai-canvas-btn w-10 h-10 shrink-0 rounded-xl flex items-center justify-center text-white transition-transform active:scale-95 disabled:opacity-40"
            >
              <Send size={16} />
            </button>
          </div>
        ...
        {/* Footer */}
        {/* <footer className="relative z-10 px-4 py-2.5 flex justify-between items-center text-[#4b4454]/60 bg-white/10">
          <span className="text-[11px]">AI Canvas v1.0</span>
          <div className="flex gap-3">
            <a className="text-[11px] hover:text-[#762dd7] transition-colors cursor-pointer">Privacy</a>
            <a className="text-[11px] hover:text-[#762dd7] transition-colors cursor-pointer">Help</a>
          </div>
        </footer> */}
      </div>
    </aside>
